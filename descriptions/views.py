...
class Descriptions(APIView):
    ...
    def post(self, request):
        ...
        b = DescriptionsModel(video_id=video_id, time_stamp_start=time_stamp_start, time_stamp_end=time_stamp_end, descriptions=descriptions, username=user, ai_or_human=ai_or_human, group_id=group_id)
        b.save()
